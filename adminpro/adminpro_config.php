...
**MySQL CONFIGURATION*************************************************************
*/
$globalConfig['dbhost']="niksicko"; // Your MySQL Server Host URL
$globalConfig['dbuser']="adminpro"; // Your MySQL Username
$globalConfig['dbpass']="(dOOr.kEEper)"; // Your MySQL Password
$globalConfig['dbase']=USERS_DB; // Your MySQL Database name
$globalConfig['tbl']="userslist"; // The name of the MySQL table to store the data required
...
$globalConfig['tblEmail']="email"; // The name of the email field of the MySQL table
...
**********************************************************************************
*/
$globalConfig['inactiveDay']="365"; // The time in days to force new login, if account has been inactive
$globalConfig['loginUrl']="index.php"; // The URL of the login page
$globalConfig['logoutUrl']="index.php"; // The URL of the logout page
/*
...
$globalConfig['cookieExpDays']="365"; // num of days, when remember me cookies expire
/*
...
**********************************************************************************
*/
$globalConfig['errorCssUrl']="css/adminpro.css";
/*
**********************************************************************************
*/
/*
