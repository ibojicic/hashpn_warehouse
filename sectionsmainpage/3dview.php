<body id="d3view">
    ...
    <script>
        ...
        var pixTopc = 1930;
        var datafile =  '../images/plots/<?php echo "ivan"?>_jsongpne.json';
        // 1900 px = 8kpc
        ...
        function init() {
            ...
            $.each(datasets, function (key, val)
            {
                ...
                geometry1.vertices.push(vertex, zeroex);

                lines = new THREE.Line(geometry1, materials[i]);
                scene.add(lines);
